...
const STRINGS: Record<MarketingLang, Record<string, string>> = {
  en: {
    ...
    "hub.forkMockBody":
      "Full timed simulations for IELTS Academic (5 mocks) and IELTS General Training (3 mocks) — all 4 skills, AI scoring plus human review. Buy one mock or a pack. No course signup.",
    "hub.forkMockMeta": "From 169 SAR · Academic & General · ~3 hours",
    "hub.forkMockCta": "View mock exams →",
    "mockExams.heroEyebrow": "IELTS Academic & General Training",
    "mockExams.heroTitle": "Full IELTS Mock Exams",
    "mockExams.heroSubtitle":
      "Choose Academic or General Training below. Real exam conditions. AI + human evaluation. No course enrollment required.",
    "mockExams.heroTrust":
      "Every Writing and Speaking result is reviewed by a certified Speakify IELTS trainer.",
    "mockExams.individualTitle": "Academic mocks",
    ...
    "mockExams.packsTitle": "Academic mock packs",
    "mockExams.packsSubtitle": "Save when you buy multiple Academic mocks upfront.",
  ...
  ar: {
    ...
    "hub.forkMockBody":
      "محاكاة كاملة لآيلتس أكاديمي (٥ محاكاة) وآيلتس جنرال تريننغ (٣ محاكاة) — ٤ مهارات، توقيت حقيقي، تقييم بالذكاء الاصطناعي ومراجعة بشرية. بدون التسجيل في دورة.",
    "hub.forkMockMeta": "من ١٦٩ ريال · أكاديمي وجنرال · ~٣ ساعات",
    "hub.forkMockCta": "عرض المحاكاة ←",
    "mockExams.heroEyebrow": "آيلتس أكاديمي وجنرال تريننغ",
    "mockExams.heroTitle": "محاكاة آيلتس الكاملة",
    "mockExams.heroSubtitle":
      "اختر أكاديمي أو جنرال تريننغ أدناه. ظروف الاختبار الحقيقية. ذكاء اصطناعي + مراجعة بشرية. بدون التسجيل في دورة.",
    "mockExams.heroTrust": "كل نتيجة كتابة وتحدث تُراجع من مدرب آيلتس معتمد في سبيكيفاي.",
    "mockExams.individualTitle": "محاكاة أكاديمية",
    "mockExams.individualSubtitle": "٥ محاكاة أكاديمية — اشترِ واحدة أو وفّر مع الباقة.",
    ...
    "mockExams.packsTitle": "باقات المحاكاة الأكاديمية",
    "mockExams.packsSubtitle": "وفّر عند شراء عدة محاكاة أكاديمية.",
