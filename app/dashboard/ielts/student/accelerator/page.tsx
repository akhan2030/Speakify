...
function WeekTimeline({ weeks, currentWeek }: { weeks: TrackWeek[]; currentWeek: number }) {
  return (
...
export default function IeltsTrackPage() {
  ...
  return (
    <main className="min-h-screen flex-1 bg-slate-50 p-4 pb-24 md:p-6 md:pb-6">
      ...
      <header className="mt-4 rounded-xl bg-[#0d1b35] p-6 text-white">
        <p className="text-xs uppercase tracking-wide text-[#c9972c]">My Track</p>
            ...
            >
              ...
              >
                <div>
                  ...
                  <h3 className="mt-1 font-bold text-[#0d1b35]">{w.title}</h3>
                </div>
      ...
      {at100 ? (
        <section className="mt-6 rounded-xl border-2 border-[#c9972c] bg-[#c9972c]/10 p-6 text-center">
