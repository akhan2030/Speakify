...
const BASE = "/dashboard/ielts-general/student/speaking";
          ...
          return (
            <div>
              <PartPracticeCard
                ...
                subtitle="Everyday topics — home, work, hobbies. Record in browser; AI transcribes and scores fluency, vocabulary, grammar, pronunciation."
                minutes="4–5 minutes · Voice recording"
                href={`${BASE}/part1`}
                color="#c9972c"
              />
              <p className="mt-4 rounded-lg bg-[#0d9488]/10 px-4 py-3 text-sm text-[#0d1b35]">
                <strong>General Training tip:</strong> Use natural, everyday English — clear
                examples from daily life score well in fluency and vocabulary.
              </p>
            </div>
          );
        }
        ...
        if (tab === "part3") {
          return (
            <PartPracticeCard
              part="Part 3"
              title="Discussion"
              subtitle="Follow-up questions linked to Part 2. Practice explaining opinions on practical topics."
...
export default function IeltsGeneralSpeakingPage() {
  return (
