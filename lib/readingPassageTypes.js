...
const INSTRUCTIONS = {
  ...
  "matching-features":
    "Look at the following statements. Match each statement with the correct feature from the list. You may use any letter more than once.",
  "matching-sentence-endings":
    "Complete each sentence with the correct ending. Choose from the list of endings. There are more endings than sentences. You may use each letter once only.",
  "sentence-completion":
  ...
  classification:
    "Classify each statement according to the categories below. Write the correct letter. You may use any letter more than once.",
};
...
export function slugToQuestionKind(slug) {
  ...
  if (key === "matching-information") return "matching-information";
  if (key === "classification") return "classification";
  if (key === "matching-sentence-endings") return "matching-sentence-endings";
  if (key === "matching-features") return "matching-features";
  if (key === "diagram-completion") return "diagram-completion";
  if (
