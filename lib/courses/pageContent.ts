...
const PAGE_CONTENT: Record<string, CoursePageContent> = {
  ...
  "ielts-gt-plus": {
    ...
    curriculum: [
      ...
      { week: "Week 8", title: "3 Full Timed GT Mocks", detail: "Three full timed General Training mocks with AI-scored writing and a weak-area plan" },
    ],
  },
  "ielts-gt-elite": {
  ...
  "step-preparation": {
    ...
    idealFor: [
      ...
      "Learners preparing for Qiyas STEP (كفايات اللغة الإنجليزية)",
