...
const SPEAKER_LABEL_RE =
  /^((?:Speaker\s+[A-Z]|Tutor|Student\s+[A-Z]?|Student|Narrator|Guide|Lecturer|Question(?:er)?|Coordinator|Caller|Receptionist|Admissions|Booking|Gallery|Host|Agent|Customer|Supervisor|Guest|Staff|Manager|Operator|Clerk|Officer)|[A-Z][a-z]{2,20}):\s*(.*)$/i;
