  ...
  "words": [
    {
      ...
      "definition": "string",
      "arabic_equivalent": "string (1-3 MSA words)",
      "definition_arabic": "string (natural MSA definition sentence)",
...
Return JSON { "words": [ { "word", "part_of_speech", "definition", "arabic_equivalent", "definition_arabic", "pronunciation_ipa", "example_sentence", "ielts_example", "collocations"[4], "memory_hook", "saudi_context", "topic_category" } ] }`;
